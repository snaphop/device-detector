...
public class DeviceDetector {
  ...
  private DeviceDetector(
      List<AbstractDeviceParser> deviceParsers,
  ...
  public Detection detect(String userAgent) {
    ...
    return new Detection(
        userAgent, device.orElse(null), operatingSystem.orElse(null), client.orElse(null));
  }
  ...
  public static class DeviceDetectorBuilder {
    ...
    public DeviceDetector build() {
      ...
      return new DeviceDetector(deviceParsers, operatingSystemParser, clientParsers);
    }
  }
}
